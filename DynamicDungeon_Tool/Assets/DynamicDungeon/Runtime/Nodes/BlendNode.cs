...
namespace DynamicDungeon.Runtime.Nodes
{
    ...
    public sealed class BlendNode : IGenNode, IInputConnectionReceiver, IParameterReceiver
    {
        private const int DefaultBatchSize = 64;
        private const string DefaultNodeName = "Blend";
        ...
        public BlendNode(string nodeId, string nodeName, string inputAChannelName, string inputBChannelName, string maskChannelName, string outputChannelName)
        {
